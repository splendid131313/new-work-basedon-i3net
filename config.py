...
model_arg.add_argument("--flowseek_finetune_mode", type=str, default="frozen", help=("frozen | adapter | refine | full "),
)
...
misc_arg.add_argument('--ckpt_dir', type=str, default='lung mdf',help='saved filename')
