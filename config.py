...
learn_arg.add_argument('--lambda_gra', type=float, default=0.00)
learn_arg.add_argument('--lambda_flow', type=float, default=0.00)
learn_arg.add_argument('--lambda_ssim', type=float, default=0.0)
# Misc
misc_arg = add_argument_group('Misc')
misc_arg.add_argument('--ckpt_dir', type=str, default='norm0-4095',help='saved filename')
