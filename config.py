...
data_arg.add_argument('--traindata_path', type=str, default='/remote-home/share/Medical/Prostate-MRI/i3_dataset/train')
...
model_arg.add_argument("--flow_cfg", type=str, default="flowseek-T-med.json")
model_arg.add_argument("--flow_ckpt", type=str, default="./model_zoo/flowseek/weights/flowseek_T_prostate.pth")
model_arg.add_argument(
    "--flowseek_finetune_mode",
    type=str,
    default="frozen",
    help=(
        "FlowSeek 分段微调: frozen | merge_head | heads | adapter | lite | refine | full "
    ),
)
...
misc_arg.add_argument('--ckpt_dir', type=str, default='prostate retrain flow',help='saved filename')
